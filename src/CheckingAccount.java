...
/**
 * read and write to the user's checking account file update their account
 * balance after the user do deposit or withdraw, and save the record of the
 * changes.
 */
public class CheckingAccount {
	...
	/**
	 *  this constructor pass in profile and gets
	 *  userName and fileName
	 * @param profile
	 *        profile of the customer
	 */
	public CheckingAccount(Profile profile) {
		this.theProfile = profile;
		String str = "checking.txt";
